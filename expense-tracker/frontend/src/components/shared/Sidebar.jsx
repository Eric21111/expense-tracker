...
const Sidebar = () => {
  ...
  return (
    <>
      <aside
        className={`fixed left-0 top-0 h-screen bg-white shadow-lg transition-all duration-300 ease-in-out z-40 cursor-pointer ${
    ...
    <aside
      className={`lg:hidden fixed left-0 top-0 h-screen bg-white shadow-lg transition-transform duration-300 ease-in-out z-50 ${
