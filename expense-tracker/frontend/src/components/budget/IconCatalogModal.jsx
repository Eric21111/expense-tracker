...
const IconCatalogModal = ({ isOpen, onClose, onSelectIcon, currentIcon }) => {
              ...
              <div className="grid grid-cols-6 sm:grid-cols-8 gap-2">
                {category.icons.map((icon, iconIdx) => (
                  <button
                    ...
                    className="aspect-square rounded-lg flex items-center justify-center transition-all hover:scale-105 p-1.5 sm:p-2"
...
export default IconCatalogModal;
