      ...
      >
        ...
        <div className="p-8">
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-[1.3fr_0.7fr] gap-6">
                <div className="relative" style={{ height: "240px" }}>
                  ...
                  <div
                    className="ml-12 absolute bottom-0 left-0 right-0 flex justify-between gap-2"
                    style={{ height: "24px" }}
                  >
                    {[
                      { name: "Food" },
                ...
                <div className="relative w-full max-w-[260px] mx-auto">
                  ...
                  >
                    ...
                    <path
                      ...
                      fill="none"
                      strokeLinecap="round"
                      strokeDasharray={`${Math.PI * 80 * 0.3} ${
                        Math.PI * 80 * 0.7
                      }`}
                    />
                  </svg>
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center" style={{ marginTop: "10px" }}>
                      <p
                        ...
                        style={{ color: "#34A853", fontSize: "30px" }}
                      >
                        30%
                      </p>
                      <p
                ...
                <div className="flex flex-col items-center flex-1 w-full">
                  <div className="relative mb-3">
                    <div
                      ...
                      style={{
                        background:
                          "linear-gradient(to bottom, #FFA726, #FFD54F)",
                      }}
                    >
                  ...
                  <p className="text-xs text-gray-700 text-center leading-tight max-w-xs mb-3 bg-white px-2.5 py-1 rounded-lg">
                    Congratulations! You've stayed under budget for 3
                    consecutive months. Keep up the great work!
                  </p>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            ...
            <div
              className="bg-white p-6 shadow-md border-l-4 border-green-500"
              style={{ borderRadius: "30px" }}
            >
              ...
              <div className="space-y-4 mb-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-600">
                      You're on track to exceed your food budget by PHP 500 this
                      month. Consider meal prepping.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-600">
                      You've saved PHP 200 on transportation compared to last
                      month. Keep it up!
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-600">
                      At this rate, you'll reach your PHP 5,000 savings goal in
                      3 months. Stay consistent!
                    </p>
                  </div>
                </div>
              </div>
